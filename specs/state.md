...
| **P5-10b** WAT script layer (`parse_script`) | [`10`](phase-5/10-wat-parser.md) | **unclaimed** | P5-10a (`«WAT-API-CORE»`) | `parse_script` → src-side `Script`/`WastValue`; differential vs `wast2json` (R15). Builds on 10a's `lex`+`parse_module`. |
